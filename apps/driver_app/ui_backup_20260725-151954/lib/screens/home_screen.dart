      ...
      if (r['ride_otp'] != null) ...[
        ...
        VybeFadeIn(delayMs: 60, child: Container(
          ...
          child: Row(children: [
            ...
            Text('${r['ride_otp']}', style: AppText.h1.copyWith(color: Colors.white, letterSpacing: 5, fontSize: 25)),
          ]),
        )),
      ],
      const SizedBox(height: 12),
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Row(children: [
            Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              const SizedBox(height: 3),
              Text('Rs ${r['total_fare'] ?? '--'}', style: AppText.h1.copyWith(fontSize: 30)),
            ])),
          ]),
          const SizedBox(height: 14),
      ...
      return ListView(padding: const EdgeInsets.fromLTRB(16, 14, 16, 24), children: [
        ...
        VybeFadeIn(child: Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text('Rs ${d['total_earnings'] ?? '0'}', style: AppText.h1.copyWith(color: Colors.white, fontSize: 34)),
