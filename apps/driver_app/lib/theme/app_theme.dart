...
class AppText {
  static TextStyle get h1    => GoogleFonts.plusJakartaSans(fontSize: 25, fontWeight: FontWeight.w700, color: AppColors.ink, letterSpacing: -0.5, height: 1.3);
  static TextStyle get h2    => GoogleFonts.plusJakartaSans(fontSize: 19, fontWeight: FontWeight.w700, color: AppColors.ink, letterSpacing: -0.3, height: 1.3);
  static TextStyle get h3    => GoogleFonts.plusJakartaSans(fontSize: 16, fontWeight: FontWeight.w600, color: AppColors.ink, letterSpacing: -0.1, height: 1.35);
  ...
  static TextStyle get bodyStrong => GoogleFonts.plusJakartaSans(fontSize: 13.5, fontWeight: FontWeight.w600, color: AppColors.ink, height: 1.4);
  static TextStyle get label => GoogleFonts.plusJakartaSans(fontSize: 12, fontWeight: FontWeight.w500, color: AppColors.muted, height: 1.35);
  static TextStyle get tiny  => GoogleFonts.plusJakartaSans(fontSize: 10, fontWeight: FontWeight.w700, color: AppColors.muted, letterSpacing: 0.6, height: 1.4);
  static TextStyle get button=> GoogleFonts.plusJakartaSans(fontSize: 14.5, fontWeight: FontWeight.w600, letterSpacing: 0.1, height: 1.2);
  static TextStyle get price => GoogleFonts.plusJakartaSans(fontSize: 19, fontWeight: FontWeight.w700, color: AppColors.ink, letterSpacing: -0.3, height: 1.3);
}
